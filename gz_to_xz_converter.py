...
def zip_xz(file_name: str, decomp_check=True, profiling=True, keep=False):
    ...
    print(f'{file_name} process time: {time.time() - start}')
    logging.info("{} process time: {}".format(file_name, time.time() - start))
...
if __name__ == "__main__":
    ...
    group.add_argument('-d', '--idir', help='Input directory to recursively reformat.')
